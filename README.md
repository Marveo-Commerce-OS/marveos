...
# Payment verification (must be live in production)
...
# Support OTP/session trust secrets
MARVEO_SUPPORT_OTP_SECRET=replace-with-random-secret
MARVEO_SUPPORT_SESSION_SECRET=replace-with-random-secret
